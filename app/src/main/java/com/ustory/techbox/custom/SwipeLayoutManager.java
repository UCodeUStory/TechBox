...
public class SwipeLayoutManager {
    ...
    public static List<SwipeLayout>swipeLayouts = new ArrayList<SwipeLayout>();
    private SwipeLayout currentLayout;//用来记录当前打开的SwipeLayout
    public void setSwipeLayout(SwipeLayout layout){
       // this.currentLayout = layout;
        if (!swipeLayouts.contains(layout)){
            swipeLayouts.add(layout);
        }
    }
    ...
    public void closeCurrentLayout(){
        Log.i("qiyue","closeCurrentLayout1");
        if(swipeLayouts!=null){
            Log.i("qiyue","closeCurrentLayout2");
